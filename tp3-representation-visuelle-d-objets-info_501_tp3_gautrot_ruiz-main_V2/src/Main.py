...
def Q3a():
    return Configuration().add(Wall({'position': [0, 0, 0], 'width':10, 'height':10, 'thickness': 1})) 

def Q4a():
    wall1 = Wall({'position': [0, 0, 0], 'width':11, 'height':5, 'thickness': 0.5, 'orientation': 0})
    wall2 = Wall({'position': [-11, 0, 0], 'width':11, 'height':5, 'thickness': 0.5, 'orientation': -90})
    wall3 = Wall({'position': [-11, -11, 0], 'width':11, 'height':5, 'thickness': 0.5, 'orientation': -180})
    wall4 = Wall({'position': [0, -11, 0], 'width':11, 'height':5, 'thickness': 0.5, 'orientation': -270})
